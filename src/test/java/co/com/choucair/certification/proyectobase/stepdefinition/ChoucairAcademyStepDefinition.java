...
public class ChoucairAcademyStepDefinition {
    ...
    public void thanJulianaWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled("Juliana").wasAbleTo(OpenUp.thePage(), (Login.OnThePage()));
    }
